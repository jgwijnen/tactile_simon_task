...
tactor_set_freq1(240);
tactor_set_freq2(240);
...
include "SimonTactile_subs_EAI.pcl";
include "SimonTactile_instructs_EAI.pcl";
...
array<int>ITI_durations [9] = {4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000 };
	...
	loop int t=1; until t>nr_of_trials begin
		...
		if blockcon[b].find("Vis")>0 then						
			...
			if continuous then				
				...
				tactor_on(outportcode, tactile_stim_duration);
				...
				tactor_on(outportcode, pulse_duration);
